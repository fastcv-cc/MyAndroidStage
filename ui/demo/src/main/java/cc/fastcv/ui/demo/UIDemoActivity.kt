...
class UIDemoActivity : StageActivity() {
    ...
    private fun setupRecyclerView() {
        ...
        adapter.setOnItemClickListener(object : BaseRecyclerViewAdapter.OnItemClickListener<UIComponent> {
    ...
    inner class UIComponentAdapter(private val items: List<UIComponent>) : BaseRecyclerViewAdapter<UIComponent>() {
